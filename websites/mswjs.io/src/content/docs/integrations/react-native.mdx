...
If scoping the handlers does not resolve the issue, you can defer starting the server until after Expo Router has completed its initial navigation. Do this by initializing MSW inside a `useEffect` in your root layout:
